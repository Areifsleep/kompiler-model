...
// Generated: 2025-12-28T13:27:32.193Z
// ============================================================================
...
export class Person {
  public Person_ID: unique_ID;
  public Nama: string;
  public Email: string;

  constructor(Person_ID: unique_ID, Nama: string, Email: string) {
    this.Person_ID = Person_ID;
    this.Nama = Nama;
    this.Email = Email;
  }

  getPerson_ID(): unique_ID {
...
export class MataKuliah {
  public MK_ID: unique_ID;
  public Kode: string;
  public Nama: string;
  public SKS: number;
  public kRSList: inst_ref_set<KRS>;

  constructor(MK_ID: unique_ID, Kode: string, Nama: string, SKS: number) {
    this.MK_ID = MK_ID;
    this.Kode = Kode;
    this.Nama = Nama;
    this.SKS = SKS;
...
export class LogCuti {
  public Log_ID: unique_ID;
  public MHS_ID: unique_ID;
  ...
  setMHS_ID(MHS_ID: unique_ID): void {
    this.MHS_ID = MHS_ID;
  }
...
export class Mahasiswa extends Person {
  ...
  dinyatakanLulus(params: MHS3EventParams): void {
    if (this.Current_State === "Aktif") {
      ...
      let krs_completed = this.getKRSList().filter(
      ...
      LOG.LogInfo({
        message:
          "Mahasiswa lulus! IPK: " + this.IPK + ", Total SKS: " + total_sks,
      });
      // 6. Notify related entities
      let person = this.getPerson();
      if (person !== null && person !== undefined) {
        LOG.LogInfo({
          message: "Selamat kepada " + person.Nama + " yang telah lulus!",
        });
      }
      this.Current_State = "Lulus";
    } else {
...
export class KRS {
  public KRS_ID: unique_ID;
  public MHS_ID: unique_ID | null;
  public MK_ID: unique_ID | null;
  public Semester: number;
  public Nilai: string;
  public Status: string;
  public SKS: number;
  public mahasiswa: inst_ref<Mahasiswa>;
  public mataKuliah: inst_ref<MataKuliah>;
  ...
  getMHS_ID(): unique_ID | null {
    return this.MHS_ID;
  }

  getMK_ID(): unique_ID | null {
    return this.MK_ID;
  }
